...
The portfolio is a static presentation that renders committed governed artifacts; it performs no browser inference and has no runtime dependency on external services or data sources.
